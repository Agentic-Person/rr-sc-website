...
export const ROOFING_MATERIALS: RoofingMaterial[] = [
  ...
  },
  {
    ...
    category: 'asphalt',
    estimateTier: 'best',
    description: 'The first and only asphalt shingle system with a hail warranty. TAMKO HailGuard features ImpactCore™ Technology — next-generation polymer modified asphalt and advanced fiberglass mat engineering — rated UL 2218 Class 4 impact resistance and backed by a 160 mph system wind warranty. The hail warranty (active as of March 2026) requires Synthetic Guard™ and Moisture Guard® underlayments and can help homeowners avoid paying a deductible after a hailstorm.',
    ...
    lifespanMin: 30,
    lifespanMax: 50,
    windRating: '160 mph (system warranty with TAMKO starter + hip & ridge)',
    warranty: 'Limited Lifetime + Hail Warranty (system)',
    bestFor: ['Hail-prone areas', 'Storm-prone coastal homes', 'Homeowners seeking insurance premium discounts', 'Maximum impact and wind protection', 'Coastal South Carolina homes'],
    pros: [
      'First and only asphalt shingle with a hail warranty (as of March 2026)',
      'UL 2218 Class 4 impact resistance — TAMKO\'s ImpactCore™ Technology',
      '160 mph system wind warranty (with TAMKO starter + hip & ridge)',
      'Granules hold firm under impact — advanced asphalt formulation',
      'Can be installed in temperatures down to 25°F',
      'May qualify for homeowners insurance premium discounts',
      'CRRC-listed color available (Olde English Pewter — energy efficient)',
    ],
    cons: ['System warranty requires TAMKO-specified underlayments (Synthetic Guard™ + Moisture Guard®)', 'Less brand recognition than Owens Corning or GAF'],
    scClimateNotes: 'TAMKO HailGuard is engineered for markets like Charleston where hail, hurricanes, and severe storms are a real threat. The 160 mph system wind warranty (with TAMKO starter and hip & ridge) exceeds even Category 5 hurricane thresholds. ImpactCore™ Technology — polymer modified asphalt plus advanced fiberglass mat — is specifically designed to withstand real-world hail impacts, not just pass the UL steel ball drop test. The hail warranty is unique in the asphalt shingle industry and can help SC homeowners avoid out-of-pocket deductibles after a storm. Many South Carolina insurers offer premium discounts for Class 4 impact-rated shingles.',
